...
from lib.helpers.display_progress import progress_for_pyrogram, download_progress_hook, read_stderr
...
@Client.on_message(filters.private & (filters.video | filters.document | filters.audio | filters.voice))
